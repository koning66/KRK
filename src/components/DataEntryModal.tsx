          ...
          {mode === 'scan' ? (
            <div className="h-full flex flex-col justify-center items-center gap-6">
              ...
              <button
                ...
                disabled={loading}
                className="inline-flex items-center gap-2 text-sm font-semibold text-pop-dark/80 hover:text-pop-dark px-4 py-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors disabled:opacity-60"
              >
